...
namespace AccessTokenClient.Tests
{
    public class TokenClientUnitTests
    {
        ...
        {
            const string Response = @"{""access_token"":""1234567"",""token_type"":""Bearer"",""expires_in"":7199}";
            var logger = new MockLogger<AccessTokenClient>();
            ...
            var decorator = new TokenClientCachingDecorator(tokenClient, cacheMock.Object, keyGeneratorMock.Object, calculatorMock.Object, mockCipherService.Object);
